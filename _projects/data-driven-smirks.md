...
An automated data-driven approach could discover optimal chemical environment distinctions directly from QM data, potentially improving transferability and coverage while substantially reducing the expert curation burden for future force field development cycles. This is particularly valuable for extending OpenFF to new chemical domains (carbohydrates, nucleic acids, macrocycles) where expert SMIRKS knowledge is less mature. The Cole group has done some experimentation with this with hyper-specific SMIRKS. We may be able to cluster these.
